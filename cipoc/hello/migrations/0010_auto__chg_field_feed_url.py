...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hello_feed', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Feed.url'
        db.alter_column(u'hello_feed', 'url', self.gf('django.db.models.fields.URLField')(max_length=30))
